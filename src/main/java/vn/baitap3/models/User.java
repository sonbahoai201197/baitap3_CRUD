...
public class User {
    ...
    public User(int id, String email, String username, String password, String fullname,
        ...
        this.fullname = fullname; this.avatar = avatar; this.roleid = roleid;
        this.phone = phone; this.createdDate = createdDate;
    }

    // Constructor cho insert (không cần id, createdDate)
    public User(String email, String username, String password, String fullname, String phone) {
        ...
        this.fullname = fullname; this.phone = phone; this.roleid = 3; // default user
        this.createdDate = new Date();
    }

    // getters & setters (generate)
    // ... (để ngắn, bạn hãy generate trong Eclipse: Source -> Generate Getters and Setters)
    // ví dụ:
